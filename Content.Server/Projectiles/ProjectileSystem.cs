...
public sealed class ProjectileSystem : SharedProjectileSystem
{
    ...
    /// </summary>
    private const float MinRaycastVelocity = 85f; // 100->75 Mono, 75->85 Final Frontier
    ...
    public override DamageSpecifier? ProjectileCollide(Entity<ProjectileComponent, PhysicsComponent> projectile, EntityUid target, MapCoordinates? collisionCoordinates, bool predicted = false)
    {
        ...
        if (modifiedDamage == null)
        {
            ...
            if (component.DeleteOnCollide && component.ProjectileSpent && !component.AlwaysReflect)
                QueueDel(uid);
            return null;
        }
        ...
        if (component.PenetrationThreshold != 0)
        {
            ...
            if (component.PenetrationDamageTypeRequirement != null)
            {
                ...
                if (stopPenetration && !component.AlwaysReflect)
                    component.ProjectileSpent = true;
            }

            // If the object won't be destroyed, it "tanks" the penetration hit.
            if (modifiedDamage.GetTotal() < damageRequired && !component.AlwaysReflect)
            {
                component.ProjectileSpent = true;
            }

            if (!component.ProjectileSpent && !component.AlwaysReflect)
            {
